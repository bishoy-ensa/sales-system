<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GarasERP.Master" AutoEventWireup="true" CodeBehind="EditClient.aspx.cs" Inherits="GarasSales.Sales.Client.EditClient" %>
        ...
        <div class="row upperCard">
            <div class="col">
                    ...
                    <div class="innerDiv pb-5">
                        ...
                        <div id="newClientPage" runat="server" visible="false" class="addContainer">
                            ...
                            <asp:UpdatePanel ID="updatePanelClientType" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <h4 class="robotoMed primaryBlue">EDIT CLIENT</h4>
                                    <div class="row my-5">
                                        <div class="col-md-1">
                ...
                <asp:RadioButton ID="rbIndividual" runat="server" GroupName="rbgrpClientType" AutoPostBack="true" />
                                    ...
                                    <p class="robotoBold">Address <span>*</span></p>

                                    <div class="dropdown d-inline-block">
                                        <asp:HiddenField ID="HDN_AddressID" runat="server" />
                                        ...
                                        <asp:RequiredFieldValidator ID="RFV_ddlCountry" runat="server" ErrorMessage="*" ControlToValidate="ddlCountry" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="dropdown d-inline-block">
                                        <asp:DropDownList ID="ddlGovernate" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlGovernate_SelectedIndexChanged" class="btn btn-light dropdown-toggle py-0 form-control">
                                        </asp:DropDownList>
                                      
                                        <asp:RequiredFieldValidator ID="RFV_ddlGovernate" runat="server" ErrorMessage="*" ControlToValidate="ddlGovernate" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    ...
                                    <div id="address2" runat="server" visible="false">
                                        ...
                                        <asp:HiddenField ID="HDN_AddressID2" runat="server" />
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <asp:RequiredFieldValidator ID="RFV_ddlCountry2" Enabled="false" runat="server" ErrorMessage="*" ControlToValidate="ddlCountry2" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </div>

                                        <div class="dropdown d-inline-block">
                                            <asp:DropDownList ID="ddlGovernate2" AutoPostBack="true" OnSelectedIndexChanged="ddlGovernate2_SelectedIndexChanged" runat="server" class="btn btn-light dropdown-toggle py-0 form-control">
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RFV_ddlGovernate2" Enabled="false" runat="server" ErrorMessage="*" ControlToValidate="ddlGovernate2" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="dropdown d-inline-block">
                                    ...
                                    <div id="address3" runat="server" visible="false">
                                        ...
                                        <asp:HiddenField ID="HDN_AddressID3" runat="server" />
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <asp:RequiredFieldValidator ID="RFV_ddlCountry3" Enabled="false" runat="server" ErrorMessage="*" ControlToValidate="ddlCountry3" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </div>

                                        <div class="dropdown d-inline-block">
                                            <asp:DropDownList ID="ddlGovernate3" AutoPostBack="true" OnSelectedIndexChanged="ddlGovernate3_SelectedIndexChanged" runat="server" class="btn btn-light dropdown-toggle py-0 form-control">
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RFV_ddlGovernate3" Enabled="false" runat="server" ErrorMessage="*" ControlToValidate="ddlGovernate3" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="dropdown d-inline-block">
                                    ...
                                    <div class="row">
                                        ...
                                        ErrorMessage="You must Enter an email" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>--%>
                                            ...
                                            <asp:HiddenField ID="HDN_PhoneID" runat="server" />
                                            ...
                                            <div id="newPhone" runat="server" visible="false">
                                                ...
                                                <p class="robotoReg d-inline-block mb-2 ">Phone Number :</p>
                                                 <asp:HiddenField ID="HDN_PhoneID2" runat="server" />
                                            ...
                                            <div id="newPhone3" runat="server" visible="false">
                                                ...
                                                <p class="robotoReg d-inline-block mb-2 ">Phone Number :</p>
                                                <asp:HiddenField ID="HDN_PhoneID3" runat="server" />
                                            ...
                                            <asp:HiddenField ID="HDN_MobileID" runat="server" />
                                            ...
                                            <div id="newMobile2" runat="server" visible="false">
                                                ...
                                                <asp:HiddenField ID="HDN_MobileID2" runat="server" />
                                            ...
                                            <div id="newMobile3" runat="server" visible="false">
                                                <p class="robotoReg d-inline-block mb-2 ">Mobile :</p>
                                                 ...
                                                 <asp:HiddenField ID="HDN_MobileID3" runat="server" />
                                            ...
                                            <%--                                    <input type="text" class="greyInput ml-3">--%>
                                             <asp:HiddenField ID="HDN_FAXID" runat="server" />
                                            ...
                                            <div id="newFax2" runat="server" visible="false">
                                                ...
                                                <asp:HiddenField ID="HDN_FaxID2" runat="server" />
                                            ...
                                            <div id="newFax3" runat="server" visible="false">
                                                ...
                                                <asp:HiddenField ID="HDN_FaxeID3" runat="server" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 px-2">
                                            ...
                                            <asp:HiddenField ID="HDN_ContactID" runat="server" />
                                        ...
                                        <div class="col-md-3 px-2">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbxContactTitle"
                                    ...
                                    <div id="newContact2" runat="server" visible="false">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 px-2">
                                                <asp:HiddenField ID="HDN_ContactID1" runat="server" />
                                            ...
                                            <div class="col-md-3 px-2">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" Enabled="false" runat="server" ControlToValidate="tbxContactTitle2"
                                                    ValidationGroup="NewClientValidation" ErrorMessage="You must Enter the Contact Person Title" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                                            </div>
                                            <div class="col-md-3 px-2">
                                    ...
                                    <div id="newContact3" runat="server" visible="false">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 px-2">
                                                <asp:HiddenField ID="HDN_ConractID2" runat="server" />
                                            ...
                                            <div class="col-md-3 px-2">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" Enabled="false" runat="server" ControlToValidate="tbxContactTitle3"
                                                    ValidationGroup="NewClientValidation" ErrorMessage="You must Enter the Contact Person Title" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                                            </div>
                                            <div class="col-md-3 px-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <span class="pr-5 mr-5">1.</span>
                                                ...
                                                <asp:HiddenField ID="HDN_SpecialityID" runat="server" />
                                            ...
                                            <div id="speciality2" runat="server" visible="false">
                                                <div class="dropdown">
                                                    <asp:HiddenField ID="HDN_SpecialityID2" runat="server" />
                                            ...
                                            <div id="speciality3" runat="server" visible="false">
                                                <div class="dropdown">
                                                    <asp:HiddenField ID="HDN_SpecialityID3" runat="server" />
                                            ...
                                            <div id="speciality4" runat="server" visible="false">
                                                <div class="dropdown">
                                                    <asp:HiddenField ID="HDN_SpecialityID4" runat="server" />
                            ...
                            <asp:UpdatePanel ID="updatePanelConsultantType" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <div id="consultantFirstDiv" class="row" runat="server" >
                                        <div class="col-md-9 ">
                                            <asp:HiddenField ID="HDN_ConsultantID" runat="server" />
                                    ...
                                    <input type="text" class="greyInput ml-5 px-5 clinetInfoInput">--%>
                                            ...
                                            <div class="row">
                                               ...
                                               <div class="col-md-3 px-2 dropdown d-inline-block">
                                                    <asp:HiddenField ID="HDN_ConsultantSpecialtyID" runat="server" />
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col-md-9">
                                                            ...
                                                            <asp:HiddenField ID="HDN_ConsultantEmailID" runat="server" />
                                                            ...
                                                            <div id="newConsultantEmail2" runat="server" visible="false">
                                                                ...
                                                                <asp:HiddenField ID="HDN_ConsultantEmailID2" runat="server" />
                                                            ...
                                                            <div id="newConsultantEmail3" runat="server" visible="false">
                                                                ...
                                                                <asp:HiddenField ID="HDN_ConsultantEmailID3" runat="server" />
                                                            ...
                                                            <asp:HiddenField ID="HDN_ConsultantPhoneID" runat="server" />
                                                            ...
                                                            <div id="newConsultantPhone2" runat="server" visible="false">
                                                                ...
                                                                <asp:HiddenField ID="HDN_ConsultantPhoneID2" runat="server" />
                                                            ...
                                                            <div id="newConsultantPhone3" runat="server" visible="false">
                                                                ...
                                                                <asp:HiddenField ID="HDN_ConsultantPhoneID3" runat="server" />
                                                            ...
                                                            <br>
                                                            <p class="robotoReg d-inline-block mb-2 ">Mobile</p>
                                                            <asp:HiddenField ID="HDN_ConsultantMobileID" runat="server" />
                                                            ...
                                                            <div id="newConsultantMobile2" runat="server" visible="false">
                                                                ...
                                                                <asp:HiddenField ID="HDN_ConsultantMobileID2" runat="server" />
                                                            ...
                                                            <div id="newConsultantMobile3" runat="server" visible="false">
                                                                ...
                                                                <asp:HiddenField ID="HDN_ConsultantMobileID3" runat="server" />
                                                            ...
                                                            <br>
                                                            <p class="robotoReg d-inline-block mb-2 ">Fax</p>
                                                            <asp:HiddenField ID="HDN_ConsultantFaxID" runat="server" />
                                                            ...
                                                            <div id="newConsultantFax2" runat="server" visible="false">
                                                                <asp:Button ID="btnRemoveConsultantFax2" runat="server" Text="x" CausesValidation="false" class="btn mr-3 darkBlue text-white robotoMed" CommandName="RemoveConsultantFax2" />
                                                                 <asp:HiddenField ID="HDN_ConsultantFaxID2" runat="server" />
                                                            ...
                                                            <div id="newConsultantFax3" runat="server" visible="false">
                                                                ...
                                                                <asp:HiddenField ID="HDN_ConsultantFaxID3" runat="server" />
                                    ...
                                    <div id="consultantSecondDiv" runat="server" >
                                        <p class="robotoBold ">Address </p>
                                        <asp:HiddenField ID="HDN_ddlConsultantAddressID" runat="server" />
                                        <div class="dropdown d-inline-block">
                                            <%--<a class="btn btn-light dropdown-toggle py-0" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
